...
<img src="/assets/img/logstash/img1.PNG" width="100%" height="auto">
...
<img src="/assets/img/logstash/img3.PNG" width="100%" height="auto">
...
오라클 데이터베이스로부터 `Data Transfer`가 데이터를 읽어와서(1) `Data User`들에게 전달하고(2) `Data User`들은 이 데이터를 로컬에 `Data File`로 저장한다(3).
